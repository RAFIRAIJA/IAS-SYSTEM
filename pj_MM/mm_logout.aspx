<%@ Page Language="VB" MasterPageFile="~/pagesetting/Masterlogin.master" AutoEventWireup="false" CodeFile="mm_logout.aspx.vb" Inherits="mm_logout" %>
...
<table width="100%" cellpadding="0" cellspacing="0" border="0">
    ...
    <tr>
        ...
        <td valign="top" align="left">            
            ...
            <br />
            <a href="../member/Default.aspx">Klik di sini untuk Login kembali</a>               
        </td>
    </tr>
</table>        
