<%@ Control Language="vb" AutoEventWireup="false" CodeFile="ucInputNumber.ascx.vb" Inherits="ucInputNumber" %>
<input id="hdnInput" type="hidden" name="hdnInput" runat="server">
<asp:TextBox ID="txtInput" runat="server" Text="0" CssClass="inptype"></asp:TextBox>
