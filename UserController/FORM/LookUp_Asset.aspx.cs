...
public partial class UserController_FORM_LookUp_Asset : System.Web.UI.Page
{
    ...
    protected String mlLocate
    {
        get { return ((String)ViewState["mlLocate"]); }
        set { ViewState["mlLocate"] = value; }
    }
    ...
    {
        this.Title = System.Configuration.ConfigurationManager.AppSettings["mgTITLE"].ToString() + " LOOKUP ASSET V2.0";
        mlTITLE.Text = "LOOKUP ASSET V2.0";
        Session["mgDateTime"] = System.DateTime.Now;

        //if (Request.QueryString["Locate"].ToString() != "")
        //{
        //    mlLocate = Request.QueryString["Locate"].ToString();
        //}
