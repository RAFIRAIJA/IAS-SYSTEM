...
public partial class usercontroller_form_LookUp_INVCustomer : System.Web.UI.Page
{
    ...
    {
        this.Title = System.Configuration.ConfigurationManager.AppSettings["mgTITLE"].ToString() + " LIST CUSTOMER V2.02";
    ...
    protected void RetrieveData()
    {
        ...
        oEnt.SortBy = sortBy;
        oDA.GetCustomerWorksheetPaging(oEnt);
    ...
    {
        Response.Redirect("LookUp_INVCustomer.aspx");
    }
}