<%@ Page Language="C#" MasterPageFile="~/pagesetting/MasterIntern.master" AutoEventWireup="true" CodeFile="LookUpSiteCard.aspx.cs" Inherits="UserControll_form_LookUpSiteCard" %>
                    ...
                    <tr> 
                      ...
                      <td class="tdganjil">
      	                <asp:DropDownList runat="server" id="ddlSearchBy">
			                ...
			                <asp:ListItem Value="SiteCardName">SiteCard Name</asp:ListItem>
...
<body>
    ...
    <input id="hdnSiteCardID" type="hidden" name="hdnSiteCardID" runat="server" style="z-index: 103;
        left: 136px; position: absolute; top: 8px">
    <input id="hdnSiteCardName" type="hidden" name="hdnSiteCardName" runat="server" style="z-index: 104;
        left: 288px; position: absolute; top: 8px">
    <input id="hdnJobNo" type="hidden" name="hdnJobNo" runat="server" style="z-index: 103;
        left: 136px; position: absolute; top: 8px">
    <input id="hdnJobTaskNo" type="hidden" name="hdnJobTaskNo" runat="server" style="z-index: 104;
        left: 288px; position: absolute; top: 8px">
    ...
    <div>
                    ...
                    <tr> 
                      ...
                      <td class="tdganjil">
      	                <asp:DropDownList runat="server" id="ddlEntity">
			                ...
			                <asp:ListItem Value="IFS" Selected="True">IFS</asp:ListItem>
			                <asp:ListItem Value="ICS">ICS</asp:ListItem>
			                <asp:ListItem Value="IPM">IPM</asp:ListItem>

		                </asp:DropDownList>
		                <asp:TextBox runat="server"  CssClass="inptype"  id="TextBox1" Width="153px"></asp:TextBox>
                      </td>
                    </tr> 
                    <tr> 
                      <td width="20%" class="tdganjil">Search By</td>
	   ...
	   <asp:Panel ID="pnlDtGrid" Runat="server">
                ...
                <asp:DataGrid ID="dgListData" runat="server" Width="95%" AutoGenerateColumns="false"
                    AllowSorting="True" BorderColor="Black" 
                    borderwidth="0px" cellpadding="3" cellspacing="1" ForeColor="#333333" CssClass="tablegrid" 
                      onitemdatabound="dgListData_ItemDataBound" HorizontalAlign="Center">
                    <SelectedItemStyle CssClass="tdgenap"></SelectedItemStyle>
