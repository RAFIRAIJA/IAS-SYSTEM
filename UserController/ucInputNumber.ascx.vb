...
'$Header: /Clipan/eLsaClipan/UserController/ucInputNumber.ascx.vb 4     1/11/05 8:32a Rony $

'$Workfile: ucInputNumber.ascx.vb $

'-----------------------------------------------------------

'$Log: /Clipan/eLsaClipan/UserController/ucInputNumber.ascx.vb $
'
...
#Region " Event Handlers "
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        scriptJava.InnerHtml = "<script language=""javascript"">formatValue('" & txtInput.ClientID & "','" & hdnInput.ClientID & "','" & txtInputDummy.ClientID & "')</script>"
    End Sub
