...
Partial Class op_synch_user_sitecard
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        mlTITLE.Text = "Synchronize Nav User Site Card V2.07"
        Me.Title = System.Configuration.ConfigurationManager.AppSettings("mgTITLE") & "Synchronize Nav User Site Card V2.07"
        mlOBJGS.Main()
    ...
    Function Sql_InsertSiteCard(ByVal mpUSERID As String, ByVal mpUSERNAME As String, ByVal mpSITECARD As String, ByVal mpSITECARDDESC As String, ByVal mpUSERLEVEL As String, ByVal mpCOMPANYID As String) As String
        Sql_InsertSiteCard = ""
        Sql_InsertSiteCard = Sql_InsertSiteCard & " INSERT INTO OP_USER_SITE (ParentCode,SysID,DocNo,DocDate," & _
            " UserID,UserName,Linno,SiteCardID,SiteCardName,UserLevel,EntityID,RecordStatus,RecUserID,RecDate) VALUES ( " & _
            ...
            " '" & Trim(mpUSERLEVEL) & "','" & Trim(mpCOMPANYID) & "'," & _
        ...
        Try
            ...
            If mlNEWRECORD = True Then
                ...
                mlSQL = mlSQL & "DELETE FROM OP_USER_SITE WHERE PARENTCODE='" & mlFUNCTIONPARAMETER & "' AND UserID IN " & _
                    " (SELECT DISTINCT UserID FROM OP_USER_SITE_LOG) " & mlSQL_SITECARD2 & " HERE PARENTCODE='" & mlFUNCTIONPARAMETER & "';"
                If mlOBJGF.IsNone(mlSQL) = False Then mlOBJGS.ExecuteQuery(mlSQL, "PB", "ISSP3")
                mlSQL = ""

                
                mlSQLTEMP = "SELECT LineNo_,SearchName,Scat,SiteSupv_,OM,[SeniorOM],[Team Leader] FROM [" & mlCOMPANYTABLENAME & "CustServiceSite] WHERE Status='0' " & mlSQL_SITECARD
                            ...
                            If mlUSERID <> "" Then
                                ...
                                Else
                                    ...
                                    mlSQL = mlSQL & "DELETE FROM OP_USER_SITE WHERE SiteCardID = '" & mlSITECARDID & "' " & _
                                        " AND UserID = '" & mlUSERID & "' AND UserLevel = '" & mlUSERLEVEL2 & "';"
                                    mlSQL = mlSQL & Sql_InsertSiteCard(mlUSERID, mlUSERNAME, mlSITECARDID, mLSITECARDDESC, mlUSERLEVEL2, ddENTITY.Text)
