<%@ Page Language="VB" MasterPageFile="~/pagesetting/MasterIntern.master" AutoEventWireup="false" CodeFile="op_synch_user_sitecard.aspx.vb" Inherits="op_synch_user_sitecard"%>
...
<asp:Panel ID="pnFILL" runat="server">
        ...
        <tr>
            ...
            <tr>
              ...
              <tr>
                <td valign="top"><asp:Label ID="lbBRANCH" Text="08. Update All Site Card Branches" runat="server"></asp:Label></td>
                <td valign="top">:</td>
                <td valign="top"><asp:ImageButton ID="btBRANCHADD" ToolTip="Add User" ImageUrl="~/images/toolbar/submit.gif" runat="server" OnClientClick="return confirm('Submit Record ?');" /></td>            
            </tr>    
        </table> 
