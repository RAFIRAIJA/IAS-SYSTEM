...
Partial Class mk_file_list
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        mlTITLE.Text = "List File Directory V2.01"
        Me.Title = System.Configuration.ConfigurationManager.AppSettings("mgTITLE") & "List File Directory V2.01"
        mlOBJGS.Main()
        ...
        If Page.IsPostBack = False Then
            mlOBJGS.XM_UserLog(Session("mgUSERID"), Session("mgNAME"), "mk_file_list", "File List Maintenance", "")

            mlSQL = "SELECT Type,DocNo,DocDate as Date,Subject FROM MK_FILE " & mlSQLRECORDSTATUS
    ...
    Sub SearchRecord()
        ...
        If Not mlOBJGF.IsNone(mlSQL) Then
            mlSQL = "SELECT Type,DocNo,DocDate as Date,Subject FROM MK_FILE " & mlSQLRECORDSTATUS & " ORDER BY DocNo Desc"
            mlSQLSTATEMENT.Text = mlSQL
            RetrieveFieldsDetail(mlSQLSTATEMENT.Text)
            pnFILL.Visible = False
