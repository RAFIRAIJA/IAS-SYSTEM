<%@ Page language="VB" MasterPageFile="~/pagesetting/MasterIntern.master" AutoEventWireup="false" CodeFile="mk_news.aspx.vb" Inherits="mk_news" %>
...
<asp:Panel ID="pnFILL" runat="server">
    <table width="100%" cellpadding="0" cellspacing="0" border="0">
        ...
        <tr>
            <td><p>Doc No</p></td>
            <td><asp:TextBox ID="mlDOCNO" width="120" runat="server" /></td>
        </tr>
        ...
        <tr>
            ...
            <td>                
                ...
                <input id="Button1" runat="server" onclick="displayCalendar(mpCONTENT_mlDOCDATE,'mm/dd/yyyy',this)" type="button" value="D" style="background-color:Yellow" />                
        ...
        <tr>
            ...
            <td>
                ...
                <input id="btJOINDATE1" runat="server" onclick="displayCalendar(mpCONTENT_mlDOCDATE1,'mm/dd/yyyy',this)" type="button" value="D" style="background-color:Yellow" />                                
        ...
        <tr>
            ...
            <td>                
                ...
                <input id="btJOINDATE2" runat="server" onclick="displayCalendar(mpCONTENT_mlDOCDATE2,'mm/dd/yyyy',this)" type="button" value="D" style="background-color:Yellow" />                
            </td>
        </tr>
        ...
        <tr>
            <td valign="top"><p>Description 1</p></td>
            <td><asp:TextBox ID="mlDESC"  TextMode="MultiLine" width="500"  Height="200"  MaxLength="3999" runat="server" /></td>
        </tr> 
        
        <tr>
            <td valign="top"><p>Description 2</p></td>
            <td><asp:TextBox ID="mlDESC2"  TextMode="MultiLine" width="500"  Height="200"  MaxLength="3999" runat="server" /></td>
        </tr> 
        
        <tr>
            <td valign="top"><p>Description 3</p></td>
            <td><asp:TextBox ID="mlDESC3"  TextMode="MultiLine" width="500"  Height="200" MaxLength="3999" runat="server" /></td>
        </tr> 
        
        <tr>
            <td valign="top"><p>Description 4</p></td>
            <td><asp:TextBox ID="mlDESC4"  TextMode="MultiLine" width="500"  Height="200" MaxLength="3999" runat="server" /></td>
        </tr> 
        
        <tr>
            <td valign="top"><p>Image Thumbnail 1</p></td>
            <td valign="top"><p>            
            <asp:FileUpload ID="mlIMAGEP1" runat="server" Width="500"/>            
            <br />
            <asp:Image ID="mlIMAGE1" runat="server" Width="300" Height="300" /><br />
            </p></td>            
        </tr>
        
        <tr>
            <td valign="top"><p>Image Thumbnail 2</p></td>
            <td valign="top"><p>            
            <asp:FileUpload ID="mlIMAGEP2" runat="server" Width="500" />            
            <br />
            <asp:Image ID="mlIMAGE2" runat="server" Width="300" Height="300" /><br />
            </p></td>            
        </tr>
        
        <tr>
            <td valign="top"><p>Image Normal 1</p></td>
            <td valign="top"><p>            
            <asp:FileUpload ID="mlIMAGEP3" runat="server" Width="500" />      
            <br />      
            <asp:Image ID="mlIMAGE3" runat="server" Width="300" Height="300" /><br />
            </p></td>            
        </tr>        
                
        <tr>
            <td valign="top"><p>Image Normal 2</p></td>
            <td valign="top"><p>            
            <asp:FileUpload ID="mlIMAGEP4" runat="server" Width="500" />    
            <br />        
            <asp:Image ID="mlIMAGE4" runat="server" Width="300" Height="300" /><br />
            </p></td>            
        </tr>                  
...
<asp:Panel ID="pnGRID" runat="server">    
    ...
    <a href="mk_news.aspx?mpSTATUS=N">New</a>
    <a href="mk_news.aspx?mpSTATUS=D">Delete</a>
    ...
    <Columns>  
        ...
        <ItemTemplate>        
            <asp:hyperlink  Target="_blank"  runat="server" id="mlLINKVW" navigateurl='<%# String.Format("mk_doc_news.aspx?mpID={0}", Eval("DocNo")) %>' text="VW"></asp:hyperlink>
        </ItemTemplate>
        </asp:templatecolumn>                
