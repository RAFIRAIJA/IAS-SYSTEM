<%@ Page Language="VB" MasterPageFile="~/pagesetting/MasterPrint.master" AutoEventWireup="false" CodeFile="ap_rpt_mr_viewer.aspx.vb" Inherits="pj_ap_ap_rpt_mr_viewer" title="Untitled Page" EnableEventValidation ="false" %>
...
<asp:TableRow><asp:TableCell><br /><p><asp:HyperLink ID="mlLINKDOC" runat="server"></asp:HyperLink></p><br /><br /></asp:TableCell></asp:TableRow>
