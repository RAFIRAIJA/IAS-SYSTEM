<%@ Page Title="" Language="VB" MasterPageFile="~/PageSetting/MsPageBlank.master" AutoEventWireup="false" CodeFile="ap_rpt_mr_request_wait_revisi.aspx.vb" Inherits="pj_AP_ap_rpt_mr_request_wait_revisi" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="mpCONTENT" Runat="Server">
    ...
    <asp:Panel ID="pnEMAIL" runat="server">    
         <table width="100%" cellpadding="0" cellspacing="0" border="0">
            <tr>
                <td class="tdganjil" width="15%"><asp:Label ID="lbEMAIL" Text="Email CC " runat="server"></asp:Label></td>
                <td class="tdganjil" colspan="3">                             
                    <asp:TextBox ID="txMAILCC" runat="server" Width="500" CssClass ="inptype" ></asp:TextBox>    
                    <i>use comma (,) to separate the address</i>                                                                                
                </td>
            </tr>
        
            <tr>
                <td class="tdganjil"><asp:Label ID="lbCONTAINS" Text="Email Messages" runat="server"></asp:Label></td>
                <td class="tdganjil" colspan ="3">                              
                    <asp:TextBox ID="txMAILMESSAGES" CssClass ="inptype" runat="server" Width="500" Height="150" TextMode="MultiLine"></asp:TextBox>                
                </td>
            </tr>
