<%@ Page Language="VB" MasterPageFile="~/pagesetting/MasterIntern.master" AutoEventWireup="false" CodeFile="ap_rpt_mr_request_wait.aspx.vb" Inherits="ap_rpt_mr_request_wait"  %>
...
<tr><td>
    ...
    <tr>
        ...
        <td>:</td>
        <td><asp:DropDownList ID="ddENTITY" runat="server" AutoPostBack ="true" OnSelectedIndexChanged="ddENTITY_SelectedIndexChanged"></asp:DropDownList></td>     
        <td></td>
...
<asp:Panel ID="pnEMAIL" runat="server">
     ...
     <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
            <td valign="top"><asp:Label ID="lbEMAIL" Text="Email CC " runat="server"></asp:Label></td>
            <td valign="top">:</td>
            <td>                             
                <asp:TextBox ID="txMAILCC" runat="server" Width="500"></asp:TextBox>    
                <i>use comma (,) to separate the address</i>                                                                                
            </td>
        </tr>
        
        <tr>
            <td valign="top"><asp:Label ID="lbCONTAINS" Text="Email Messages" runat="server"></asp:Label></td>
            <td valign="top">:</td>
            <td valign="top">                              
                <asp:TextBox ID="txMAILMESSAGES" runat="server" Width="500" Height="150" TextMode="MultiLine"></asp:TextBox>                
            </td>
        </tr>
        ...
        <tr>
            ...
            <td></td>
            <td valign="top">
                <asp:Button ID="btEMAIL" Text="Email Now"  runat="server" OnClientClick="return confirm('Email ?');" />                
            </td>
        </tr>
      </table>
