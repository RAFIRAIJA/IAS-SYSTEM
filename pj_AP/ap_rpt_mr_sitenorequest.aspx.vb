    ...
    Sub SearchRecord()
        ...
        Try
            ...
            If Not mlOBJGF.IsNone(mlSQL) Then
                Select Case ddREPORT.Text
                    Case "No_Request"
                        If mlALLSITE = True Then
                            mlSQL = " SELECT Distinct SiteCardID,SiteCardName" & _
                ...
                If ddType.Text <> "" Then
                    mlSQL = mlSQL & IIf(mlSQL = "", "", " AND") & " BranchID = (sELECT AdditionalDescription1 FROM PROD_ISS.dbo.XM_UNIVERSALLOOKUPLIN Where UniversalID = 'ISS_Mapping_BranchCode' and AdditionalDescription3 = '" + ddEntity.SelectedValue + "' and Description = '" + ddType.SelectedValue + "')"
                End If
                ' End of Added
