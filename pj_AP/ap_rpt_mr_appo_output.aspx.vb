    ...
    Sub SearchRecord()
        Try
            ...
            If Not mlOBJGF.IsNone(mlSQL) Then
                Select Case ddREPORT.Text
                    Case "Summary"
                        mlSQL = "SELECT HR.DocNo,HR.DocDate,HR.MRType,HR.MRDesciption,HR.SiteCardID as Site,HR.SiteCardName as SiteDesc,HR.BVMonth as Period,HR.TotalAmount as Amount," & _
                            ...
                            " HR.RecordStatus as Status FROM AP_MR_REQUESTHR HR WHERE " & mlSQL
