<%@ Page Language="VB" MasterPageFile="~/pagesetting/MasterIntern.master" AutoEventWireup="false" CodeFile="ap_post_mrbatch_appo_test.aspx.vb" Inherits="ap_post_mrbatch_appo"  %>
...
<table border="0" cellpadding="3" cellspacing="3">
    <tr>        
        <td><asp:ImageButton id="btSaveRecord" ToolTip="SaveRecord" ImageUrl="~/images/toolbar/save.jpg" runat="server" OnClientClick="return confirm('Submit Record ?');" /></td>
...
<table width="80%" cellpadding="0" cellspacing="0" border="0">            
    <tr>
        ...
        <td>
            ...
            <input id="Button1" runat="server" onclick="displayCalendar(ctl00_mpCONTENT_mlDATEFROM,'dd/mm/yyyy',this)" type="button" value="D" style="background-color:Yellow " />
            <font color="blue">dd/mm/yyyy</font>
            <ajaxToolkit:CalendarExtender ID="CalendarExtender1" runat="server" TargetControlID="mlDATEFROM" Format="dd/MM/yyyy" />            
        </td>            
        <td></td>
        ...
        <td>
            ...
            <input id="btJOINDATE" runat="server" onclick="displayCalendar(ctl00_mpCONTENT_mlDATETO,'dd/mm/yyyy',this)" type="button" value="D" style="background-color:Yellow" />            
            <font color="blue">dd/mm/yyyy</font>
            <ajaxToolkit:CalendarExtender ID="CalendarExtender2" runat="server" TargetControlID="mlDATETO" Format="dd/MM/yyyy" />
        </td>            
    </tr>
    ...
    <tr>
        ...
        <td valign="top">
            ...
            <input id="btPERIOD" runat="server" onclick="displayCalendar(ctl00_mpCONTENT_mpPERIOD,'mm/yyyy',this)" type="button" value="D" style="background-color:Yellow " />                                                      
...
<Columns>
    ...
    <asp:BoundColumn HeaderText="SiteCard ID" DataField="SiteCardID" ItemStyle-CssClass="GridItem"></asp:BoundColumn>
