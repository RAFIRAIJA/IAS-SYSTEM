...
Partial Class ap_rpt_mr_request_mr_cr
    ...
    Protected Sub btLOCID1_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btLOCID1.Click
        lbLOCDESC1.Text = mlOBJPJ.ISS_XMGeneralLostFocus("SITECARD_DESC", Trim(txLOCID1.Text), mlOBJGS.mgACTIVECOMPANY)
    ...
    Protected Sub btLOCID2_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btLOCID2.Click
        lbLOCDESC2.Text = mlOBJPJ.ISS_XMGeneralLostFocus("SITECARD_DESC", Trim(txLOCID2.Text), mlOBJGS.mgACTIVECOMPANY)
            ...
            If Not mlOBJGF.IsNone(mlSQL) Then
                Select Case ddREPORT.Text
                    Case "MR Document"
                        ...
                        " HR.ParentCode,HR.MRType,HR.MRDesciption,HR.DocNo,HR.DocDate,HR.SiteCardID,HR.SiteCardName,HR.Location," & _
                        " HR.DeptID,HR.BVMonth,HR.Description as DescHR,HR.MRLine,HR.PercentageMR,HR.TotalPoint,HR.TotalAmount," & _
                        " HR.RecordStatus,HR.PostingUserID1,HR.PostingName1,HR.PostingDate1,HR.PostingUserID2,HR.PostingName2,HR.PostingDate2," & _
                        " HR.PostingUserID3,HR.PostingName3,HR.PostingDate3,HR.PostingUserID4,HR.PostingName4,HR.PostingDate4,HR.PostingUserID5,HR.PostingName5,HR.PostingDate5," & _
                        " HR.RecUserID,HR.RecDate,HR.SC_State,HR.SC_Branch,HR.SC_BranchCode,HR.SC_BranchName,HR.DeptCode,HR.Do_Address,HR.Do_City,HR.Do_State,HR.Do_Country,HR.Do_Zip,HR.DO_Phone1,HR.PIC_ContactNo," & _
                        " DT.*" & _
                        " FROM AP_MR_REQUESTHR HR,AP_MR_REQUESTDT DT WHERE " & mlSQL & _
                        " AND HR.DocNo = DT.DocNo"
    ...
    Protected Sub ddENTITY_SelectedIndexChanged(ByVal sender As Object, ByVal e As EventArgs) Handles ddENTITY.SelectedIndexChanged
        ddTYPE.Items.Clear()
