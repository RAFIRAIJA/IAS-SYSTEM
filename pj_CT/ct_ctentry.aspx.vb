'Log
'2.02 Update Retrievefield to Show Data only H-7 and BY UserID
...
Partial Class ct_ctentry
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        mlTITLE.Text = "Contract Maintenance V2.06"
        Me.Title = System.Configuration.ConfigurationManager.AppSettings("mgTITLE") & "Contract Maintenance V2.06"
        mlOBJGS.Main()
        ...
        Select Case mlFUNCTIONPARAMETER
            Case "1" 'Normal
                mlTITLE.Text = mlTITLE.Text & " (New Contract)"
                tr1.Visible = False
                tr2.Visible = False
                tr3.Visible = False
                tr4.Visible = False
            ...
            Case "2" 'Existing Regional
                mlTITLE.Text = mlTITLE.Text & " (Existing Regional)"
                tr1.Visible = True
                tr2.Visible = True
                tr3.Visible = True
                tr4.Visible = True
            ...
            Case "3" 'Existing Metro
                mlTITLE.Text = mlTITLE.Text & " (Existing Metro)"
                tr1.Visible = True
                tr2.Visible = True
                tr3.Visible = True
                tr4.Visible = True
            ...
            Case "4" 'Letter
                mlTITLE.Text = mlTITLE.Text & " (Letter)"
            ...
            Case "5" 'No Continue Contract
                mlTITLE.Text = mlTITLE.Text & " (Terminated Regional)"
                tr10.Visible = False
                tr9.Visible = False
                trSTARTDATE.Visible = False
                trENDDATE.Visible = False
    ...
    Protected Sub mlDATAGRID_SortCommand(ByVal Source As Object, ByVal E As DataGridSortCommandEventArgs) Handles mlDATAGRID.SortCommand
        ...
        If chkSORT.Checked = True Then
            RetrieveFieldsDetail(mlSQLSTATEMENT.Text & " ORDER BY " & E.SortExpression & " Desc")
        Else
...
'            lbBRANCH.Text = mlOBJPJ.ISS_XMGeneralLostFocus("BRANCH_DESC2", Trim(txBRANCH.Text))
    ...
    Public Sub RetrieveFields()
        ...
        Try
            ...
            If mlREADER.HasRows Then
                ...
                txPRICEMP.Text = mlREADER("PricePerMP") & ""
                txUMP.Text = mlREADER("UMP") & ""
                txUMPPERCENT.Text = mlREADER("UMPPercentage") & ""
                ...
                txPRICEMP.Text = IIf(txPRICEMP.Text = "", 0, txPRICEMP.Text)
                txUMP.Text = IIf(txUMP.Text = "", 0, txUMP.Text)
                txUMPPERCENT.Text = IIf(txUMPPERCENT.Text = "", 0, txUMPPERCENT.Text)
                ...
                txPRICEMP.Text = Convert.ToDouble(txPRICEMP.Text).ToString("n")
                txUMP.Text = Convert.ToDouble(txUMP.Text).ToString("n")
                txUMPPERCENT.Text = Convert.ToDouble(txUMPPERCENT.Text).ToString("n")
        ...
        Try
            If mpSQL = "" Then
                mlSQL2 = "SELECT DocNo, DocDate as Create_Date,ContractNo as Contract_No,ContractDate as Contract_Date," & _
                    ...
                    " WHERE RecordStatus='New' AND ParentCode='" & mlFUNCTIONPARAMETER & "'"
                mlSQLSTATEMENT.Text = mlSQL2
                mlSQL2 = mlSQL2 & " ORDER BY DocNo"
                '" WHERE DocDate >= '" & mlOBJGF.FormatDate(mlDOCDATE) & "' AND RecUserID = '" & Session("mgUSERID") & "'" & _
            Else
                mlSQL2 = mpSQL
            End If
            mlDATASET.Clear()
    ...
    Private Sub EnableCancel()
        ...
        mlOBJPJ.SetTextBox(False, txPRICEMP)
        mlOBJPJ.SetTextBox(False, txUMP)
        mlOBJPJ.SetTextBox(False, txUMPPERCENT)
    ...
    Private Sub DisableCancel()
        ...
        mlOBJPJ.SetTextBox(True, txPRICEMP)
        mlOBJPJ.SetTextBox(True, txUMP)
        mlOBJPJ.SetTextBox(True, txUMPPERCENT)
        ...
        Select Case mpSTATUS
            Case "New"
                ...
                mlSQLFILE = mlSQLFILE & " INSERT INTO XM_FILEDTU " & _
                    " (DocNo,Linno,Type,GroupID,UserID,Name,TaskID,Description," & _
                    " RecordStatus,RecUserID,RecDate) VALUES ( " & _
                    " '" & mlFS_DOCNO & "','" & mlI & "','1'," & _
                    " '" & Session("mgGROUPMENU") & "','" & Session("mgUSERID") & "','" & Session("mgNAME") & "', '" & mlPROCESSID & " ','" & mlPROCESS_SUBJECT & "'," & _
    ...
    Sub Sql_1(ByVal mpSTATUS As String, ByVal mpCODE As String)
        ...
        Try
            ...
            If mlNEWRECORD = True Then
                ...
                txUMP.Text = mlOBJGF.UnFormatMoney(txUMP.Text)
                txPRICEMP.Text = mlOBJGF.UnFormatMoney(txPRICEMP.Text)
                txUMPPERCENT.Text = mlOBJGF.UnFormatMoney(txUMPPERCENT.Text)
                txDESCRIPTION.Text = Replace(txDESCRIPTION.Text, "'", "")
                txSITECARD.Text = Replace(txSITECARD.Text, "'", "")
                txADDR.Text = Replace(txADDR.Text, "'", "")
                ...
                mlSQL = mlSQL & " INSERT INTO CT_CONTRACTHR (" & _
                            ...
                            " '" & Trim(txUMP.Text) & "','" & Trim(txPRICEMP.Text) & "','" & Trim(txUMPPERCENT.Text) & "'," & _
