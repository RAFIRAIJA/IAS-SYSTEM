<%@ Page Language="VB" MasterPageFile="~/pagesetting/MasterIntern.master" AutoEventWireup="false" CodeFile="ct_ctentry2.aspx.vb" Inherits="ct_ctentry2"%>
...
<asp:Panel ID="pnTOOLBAR" runat="server">  
    <table border="0" cellpadding="3" cellspacing="3">
        <tr>
            ...
            <td valign="top"><asp:ImageButton id="btSaveRecord" ToolTip="SaveRecord" ImageUrl="~/images/toolbar/save.jpg" runat="server" OnClientClick="return ValidateForm()" /></td>            
        ...
        <td valign="top">
            ...
            <tr>
                ...
                <td valign="top">                             
                    ...
                    <input id="btDOCDATE1" runat="server" onclick="displayCalendar(ctl00_mpCONTENT_txDOCDATE,'dd/mm/yyyy',this)" type="button" value="D" style="background-color:Yellow " />                                                                      
...
<asp:Panel ID="pnGRID3" runat="server">    
   <asp:DataGrid runat="server" ID="mlDATAGRID3" 
    ...
    <Columns> 
        ...
        <asp:TemplateColumn>
        <HeaderTemplate><asp:Label ID="lbGR_CUSTID" Text="Cust_ID" runat="server"></asp:Label></HeaderTemplate>
        <ItemTemplate>
            <asp:Label ID="lbGR_CUSTID2" runat="server"></asp:Label>
        </ItemTemplate>
        </asp:TemplateColumn>
        
        <asp:TemplateColumn>
        <HeaderTemplate><asp:Label ID="lbGR_CUSTNAME" Text="Cust_Name" runat="server"></asp:Label></HeaderTemplate>
        <ItemTemplate>
            <asp:Label ID="lbGR_CUSTNAME2" runat="server"></asp:Label>
        </ItemTemplate>
        </asp:TemplateColumn>
        
        <asp:TemplateColumn>
        <HeaderTemplate><asp:Label ID="lbGR_SITECARDID" Text="SiteCard_ID" runat="server"></asp:Label></HeaderTemplate>
        <ItemTemplate>
            <asp:Label ID="lbGR_SITECARDID2" runat="server"></asp:Label>
        </ItemTemplate>
        </asp:TemplateColumn>
                
        <asp:TemplateColumn>
        <HeaderTemplate><asp:Label ID="lbGR_SITECARDDESC" Text="SiteCard_Name" runat="server"></asp:Label></HeaderTemplate>
        <ItemTemplate>
            <asp:Label ID="lbGR_SITECARDDESC2" runat="server"></asp:Label>
        </ItemTemplate>
        </asp:TemplateColumn>
        
        <asp:TemplateColumn>
        <HeaderTemplate><asp:Label ID="lbGR_ADDR" Text="Address" runat="server"></asp:Label></HeaderTemplate>
        <ItemTemplate>
            <asp:Label ID="lbGR_ADDR2" runat="server"></asp:Label>
        </ItemTemplate>
        </asp:TemplateColumn>
       
       <asp:TemplateColumn>
        <HeaderTemplate><asp:Label ID="lbGR_CITY" Text="City" runat="server"></asp:Label></HeaderTemplate>
        <ItemTemplate>
            <asp:Label ID="lbGR_CITY2" runat="server"></asp:Label>
        </ItemTemplate>
        </asp:TemplateColumn>
        
        <asp:TemplateColumn>
        <HeaderTemplate><asp:Label ID="lbGR_STATE" Text="State" runat="server"></asp:Label></HeaderTemplate>
        <ItemTemplate>
            <asp:Label ID="lbGR_STATE2" runat="server"></asp:Label>
        </ItemTemplate>
        </asp:TemplateColumn>
        
        <asp:TemplateColumn>
        <HeaderTemplate><asp:Label ID="lbGR_COUNTRY" Text="Country" runat="server"></asp:Label></HeaderTemplate>
        <ItemTemplate>
            <asp:Label ID="lbGR_COUNTRY" runat="server"></asp:Label>
        </ItemTemplate>
        </asp:TemplateColumn>
        
        <asp:TemplateColumn>
        <HeaderTemplate><asp:Label ID="lbGR_ZIP" Text="Zip" runat="server"></asp:Label></HeaderTemplate>
        <ItemTemplate>
            <asp:Label ID="lbGR_ZIP" runat="server"></asp:Label>
        </ItemTemplate>
        </asp:TemplateColumn>
        
        <asp:TemplateColumn>
        <HeaderTemplate><asp:Label ID="lbGR_PHONE1" Text="Phone" runat="server"></asp:Label></HeaderTemplate>
        <ItemTemplate>
            <asp:Label ID="lbGR_PHONE1" runat="server"></asp:Label>
        </ItemTemplate>
        </asp:TemplateColumn>
        
        
        <asp:TemplateColumn>
        <HeaderTemplate><asp:Label ID="lbGR_PIC" Text="PIC & HP" runat="server"></asp:Label></HeaderTemplate>
        <ItemTemplate>
            <asp:Label ID="lbGR_PIC2" runat="server"></asp:Label>
        </ItemTemplate>
        </asp:TemplateColumn>
        
        <asp:TemplateColumn>
        <HeaderTemplate><asp:Label ID="lbGR_SERVICE" Text="Service Type" runat="server"></asp:Label></HeaderTemplate>
        <ItemTemplate>
            <asp:Label ID="lbGR_SERVICE2" runat="server"></asp:Label>
        </ItemTemplate>
        </asp:TemplateColumn>
        
        <asp:TemplateColumn>
        <HeaderTemplate><asp:Label ID="lbGR_SC_State" Text="SC_State" runat="server"></asp:Label></HeaderTemplate>
        <ItemTemplate>
            <asp:Label ID="lbGR_SC_State2" runat="server"></asp:Label>
        </ItemTemplate>
        </asp:TemplateColumn>
        
        <asp:TemplateColumn>
        <HeaderTemplate><asp:Label ID="lbGR_SC_BRANCH" Text="SC_Branch" runat="server"></asp:Label></HeaderTemplate>
        <ItemTemplate>
            <asp:Label ID="lbGR_SC_BRANCH2" runat="server"></asp:Label>
        </ItemTemplate>
        </asp:TemplateColumn>
        
        <asp:TemplateColumn>
        <HeaderTemplate><asp:Label ID="lbGR_SC_BRANCHID" Text="SC_BranchCode" runat="server"></asp:Label></HeaderTemplate>
        <ItemTemplate>
            <asp:Label ID="lbGR_SC_BRANCHID2" runat="server"></asp:Label>
        </ItemTemplate>
        </asp:TemplateColumn>
        
        <asp:TemplateColumn>
        <HeaderTemplate><asp:Label ID="lbGR_SC_BRANCHNAME" Text="SC_BranchName" runat="server"></asp:Label></HeaderTemplate>
        <ItemTemplate>
            <asp:Label ID="lbGR_SC_BRANCHNAME2" runat="server"></asp:Label>
        </ItemTemplate>
        </asp:TemplateColumn>
...
<asp:Panel ID="pnFILL3" runat="server">    
    <table border="0" cellpadding="0" cellspacing="0" width="60%">
       <tr>
            <td valign="top"><p><asp:Label ID="lblKOMP1" Text="Main Component"  Font-Bold="true" runat="server"></asp:Label></p></td>
            <td></td>
            <td valign="top"><p><asp:Label ID="lblKOMP2" Text="Additional Component" Font-Bold="true" runat="server"></asp:Label></p></td>
       </tr>
...
<asp:TableRow>
<asp:TableCell>
<asp:Panel ID="pnFILL4" runat="server">    
    <table>
    <tr id="trTOOLS1" runat="server">
