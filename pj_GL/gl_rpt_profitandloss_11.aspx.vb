...
Partial Class backoffice_gl_rpt_profitandloss_11
    ...
    Sub SearchRecord()
        ...
        Try
            ...
            mlRSSITETOTAL = mlOBJGS.DbRecordset(mlSQLSITETOTAL)
            ...
            mlRSCOA = mlOBJGS.DbRecordset(mlSQL_COA)
            While mlRSCOA.Read
            ...
            If mlOBJGF.IsNone(mlSQL_SITE2) = False Then
                mlRS_SITE = mlOBJGS.DbRecordset(mlSQL_SITE2)
                mlHAVINGDETAIL = True
            End If
