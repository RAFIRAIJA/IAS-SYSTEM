<%@ Page Language="VB" MasterPageFile="~/pagesetting/MasterIntern.master" AutoEventWireup="false" CodeFile="gl_rpt_profitandloss_1.aspx.vb" Inherits="backoffice_gl_rpt_profitandloss_1" title="Untitled Page" %>
...
<asp:Panel ID="Panel1" runat="server">
    ...
    <table cellspacing="1" cellpadding="1" border="1" bordercolor="#B0AEAE">
    <%
