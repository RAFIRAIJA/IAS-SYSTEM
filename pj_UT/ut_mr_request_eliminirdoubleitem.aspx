<%@ Page Language="VB" MasterPageFile="~/pagesetting/MasterIntern.master" AutoEventWireup="false" CodeFile="ut_mr_request_eliminirdoubleitem.aspx.vb" Inherits="ut_mr_request_eliminirdoubleitem"%>
...
<asp:Button ID="BTl" runat="server" Text="go" /> 
