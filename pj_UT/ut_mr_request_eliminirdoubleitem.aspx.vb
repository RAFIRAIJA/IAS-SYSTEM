...
Partial Class ut_mr_request_eliminirdoubleitem
    ...
    Sub Go()
        ...
        Dim mlITEM1 As String
        Dim mlDOCNO1 As String
        Dim mlLINNO1 As String
        Dim mlITEM2 As String
        Dim mlDOCNO2 As String
        Dim mlFIRST As Boolean
        Dim mlSTRING As String
        Dim mlSQL2 As String

        mlFIRST = True
        mlSQL = "SELECT * FROM AP_MR_REQUESTDT ORDER BY DocNO,ItemKey"
        mlREADER = mlOBJGS.DbRecordset(mlSQL, "PB", "ISSP3")
        While mlREADER.Read

            mlITEM1 = mlREADER("ItemKey")
            mlDOCNO1 = mlREADER("DocNo")
            mlLINNO1 = mlREADER("Linno")

            ''If mlDOCNO1 = "PC/MR/00000201" Then Stop
            ...
            If mlFIRST = True Then
                ...
                mlDOCNO2 = mlDOCNO1
            Else
                If mlDOCNO1 = mlDOCNO2 Then
                    If mlITEM1 = mlITEM2 Then
                        mlSTRING = mlSTRING & "<br>" & mlDOCNO1 & " - " & mlITEM1
                        mlSQL = mlSQL & " DELETE FROM AP_MR_REQUESTDT WHERE DocNo = '" & mlDOCNO1 & "' AND Linno='" & mlLINNO1 & "'; "
                        mlSQL2 = "DELETE FROM AP_MR_REQUESTDT WHERE DocNo = '" & mlDOCNO1 & "' AND Linno='" & mlLINNO1 & "'; "
                    Else
                        mlITEM2 = mlITEM1
                    End If
                Else
