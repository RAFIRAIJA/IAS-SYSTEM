<%@ Page Language="VB" MasterPageFile="~/pagesetting/MasterIntern.master" AutoEventWireup="false" CodeFile="ut_ap_fix_mrrequestdt2desc.aspx.vb" Inherits="ut_ap_fix_mrrequestdt2desc"%>
...
<asp:Panel ID="pnTOOLBAR" runat="server">  
    <table border="0" cellpadding="3" cellspacing="3">
        <tr>
            <td><asp:ImageButton id="btNewRecord" ToolTip="NewRecord" ImageUrl="~/images/toolbar/new.jpg" runat="server" visible="false" /></td>
            ...
            <td><asp:ImageButton id="btSearchRecord" ToolTip="SearchRecord" ImageUrl="~/images/toolbar/find.jpg" runat="server" visible="false" /></td>
            <td><asp:ImageButton id="btEditRecord" ToolTip="EditRecord" ImageUrl="~/images/toolbar/edit.jpg" runat="server" visible="false"/></td>            
            <td><asp:ImageButton id="btCancelOperation" ToolTip="CancelOperation" ImageUrl="~/images/toolbar/cancel.jpg" runat="server" visible="false" /></td>            
        </tr>               
    </table>
    <hr />
</asp:Panel>
...
<asp:Panel ID="pnFILL" runat="server">
    <table width="100%" cellpadding="0" cellspacing="0" border="0">                 
        ...
        <tr>
            <td><p><asp:Label ID="Label2" Text="DocID" runat="server"></asp:Label></p></td>
            <td valign="top">:</td>
