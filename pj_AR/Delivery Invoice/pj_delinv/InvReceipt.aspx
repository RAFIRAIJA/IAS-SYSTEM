<%@ Page Title="" Language="C#" MasterPageFile="~/pj_delinv/MasterInternCS.master" AutoEventWireup="true" CodeFile="InvReceipt.aspx.cs" Inherits="InvReceipt" %>
        ...
        <asp:Table id="mlTABLE1" BorderWidth ="0" CellPadding ="0" CellSpacing="0" Width="100%" runat="server">
            ...
            <asp:TableRow>
                <asp:TableCell>
                    ...
                    <div id="space"></div>
                    <div id="lblTitle1" style="font-size:16px;"><strong>INVOICE LIST</strong></div>
                    <div id="space"></div>
                    ...
                    <asp:Panel ID="mlPNLGRID" runat="server" ScrollBars="Auto" Width="1020px">
                        <table>
                            <tr>
                                ...
                                <td><span class="add" style="padding-left: 20px;"><asp:Button ID="mlBTNCREATE" runat="server" Text="Create Receipt" Height="25px" Width="125px" OnClick="mlBTNCREATE_Click"></asp:Button></span></td>
                                <td><span class="delete" style="padding-left: 20px;"><asp:Button ID="mlBTNDELETE" runat="server" Text="Delete" Height="25px" Width="125px" OnClick="mlBTNDELETE_Click"></asp:Button></span></td>
                            </tr>
                        </table>
                        <asp:DataGrid runat="server" ID="mlDGINVOICE" 
                        CssClass="Grid"
                        ...
                        OnPageIndexChanged="mlDGINVOICE_PageIndexChanged">
