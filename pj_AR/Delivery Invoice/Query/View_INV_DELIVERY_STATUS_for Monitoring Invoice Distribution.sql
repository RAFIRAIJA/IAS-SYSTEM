...
/****** Object:  View [dbo].[INV_DELIVERY_STATUS]    Script Date: 03/28/2014 11:21:30 ******/
SET ANSI_NULLS ON
GO
...
CREATE VIEW [dbo].[INV_DELIVERY_STATUS]
AS
SELECT     COUNT(InvStatus) AS PROCEEDS, DELIVERED = 0, RETURNED = 0, DONE = 0, CONVERT(nvarchar(10), InvProceedsDate, 120) AS PROCEEDSDATE, 
                      ...
                      InvDoneDate, 120) AS DONEDATE
/*INTO #INV_DELIVERY_STATUS_AWAL */ FROM INV_DELIVERY
WHERE     Disabled = 0 AND InvStatus = 'PROCEEDS'
GROUP BY InvProceedsDate, InvDeliveredDate, InvReturnedDate, InvDoneDate
UNION
...
Begin DesignProperties = 
   ...
   End
End
' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'INV_DELIVERY_STATUS'
GO

EXEC sys.sp_addextendedproperty @name=N'MS_DiagramPaneCount', @value=1 , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'INV_DELIVERY_STATUS'
GO
