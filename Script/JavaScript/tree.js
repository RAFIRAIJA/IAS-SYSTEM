...
function drawFolder(insertAtObj)
{
  ...
  if (WRAPTEXT)
     docW = docW + "</td>"+this.prependHTML+"<td valign=middle width=100% class=menu>"
  else
     docW = docW + "</td>"+this.prependHTML+"<td valign=middle nowrap width=100% class=menu>"
  if (USETEXTLINKS)
  {
...
function drawItem(insertAtObj)
{
  ...
  if (WRAPTEXT)
    docW = docW + "</td>"+this.prependHTML+"<td valign=middle width=100% class=submenu>"
  else
    docW = docW + "</td>"+this.prependHTML+"<td valign=middle nowrap width=100% class=submenu>"
...
function gLnk(target, optionFlags, description, linkData)
{
  if (optionFlags>=0) { //is numeric (old style) or empty (error)
    optionFlags = "R";
    //Target changed from numeric to string in Aug 2002, and support for numeric style was entirely dropped in Mar 2004
