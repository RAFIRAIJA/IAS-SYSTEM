...
function catchbackspace() {
  ...
  if (e.keyCode==8){
    ...
    return false;
			...
			function OpenActivity(pBranchID,pApplicationID,pAgreementNo,pCustomerID,pCustomerName,pStyle,pReferrer){
					window.open(ServerName + App + '/Collection/Inquiry/InqCollActivityResult.aspx?BranchID=' + pBranchID + '&ApplicationID=' + pApplicationID + '&AgreementNo=' + pAgreementNo + '&CustomerID=' + pCustomerID + '&CustomerName=' + pCustomerName + '&Style=' + pStyle + '&referrer=' + pReferrer , 'CollectionActivity', 'left=0, top=0, width=700, height=600, menubar=0, scrollbars=yes');
			}			
			...
			function OpenCollection(pStyle, pApplicationID, pBranchID, pCustomerID, pCustomerName, pAgreementNo){
				window.open(ServerName + App + '/Collection/Inquiry/InqCollActivityHistory.aspx?AgreementNo=' + pAgreementNo  + '&CustomerName=' + pCustomerName  + '&CustomerID=' + pCustomerID  + '&ApplicationID=' + pApplicationID + '&BranchID=' + pBranchID + '&style=' + pStyle, 'CollectionView', 'left=50, top=10, width=600, height=480, menubar=0, scrollbars=yes');
			}
			...
			function OpenBankStatement(pAppID,pBranchID,pCustName,phdnBankStatement){	
			
					window.open(ServerName + App +'/AccAcq/Credit/CreditProcess/LookUpBankStatement.aspx?ApplicationID=' + pAppID + '&pBranchID=' + pBranchID + '&CustName=' + pCustName +  '&hdnBankStatement=' + phdnBankStatement, null,'left=50, top=10, width=700, height=500, menubar=0, scrollbars=1');
			}
			function OpenWinLookUpProductOffering(pMinTenor,pMaxTenor,pCurrency, pProductOfferingID,pProductOfferingDescription,pProductOfferingDescriptionHid,pProductID,pAssetType,pIsBindTenor,pStyle,pBranchID, pIsProductByTenor){
					window.open(ServerName + App + '/General/LookUpProductOffering.aspx?mintenor=' + pMinTenor + '&maxtenor=' + pMaxTenor + '&currency='+ pCurrency + '&IsBindTenor='+ pIsBindTenor + '&style=' + pStyle + '&productofferingid=' + pProductOfferingID + '&description=' + pProductOfferingDescription + '&descriptionhid=' + pProductOfferingDescriptionHid + '&productid=' + pProductID + '&assettype='+ pAssetType + '&branchid=' + pBranchID + '&IsProductByTenor=' + pIsProductByTenor , null, 'left=50, top=10, width=800, height=600, menubar=0, scrollbars=yes');
			}
