<%@ Page Language="VB" MasterPageFile="~/pagesetting/Masterlogin.master" AutoEventWireup="false" CodeFile="xm_logout.aspx.vb" Inherits="xm_logout" %>
...
<table width="100%" cellpadding="0" cellspacing="0" border="0">
    ...
    <tr>
        ...
        <td valign="top" align="left">            
            ...
            <br />
            <a href="xm_login.aspx">Klik di sini untuk Login kembali</a>               
        </td>
    </tr>
</table>        
