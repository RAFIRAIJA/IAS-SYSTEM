<%@ Page Language="VB" MasterPageFile="~/pagesetting/MasterIntern.master" AutoEventWireup="false" CodeFile="xm_universallookup.aspx.vb" Inherits="xm_universallookup" title="Universal Lookup V2.01" %>
...
<table width="100%" cellpadding="0" cellspacing="0" border="0">               
    <tr><td>        
        <table width="70%" cellpadding="3" cellspacing="3" border="0">               
        <tr>
        <td><p>Group ID</p></td>            
        ...
        <ajax:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>        
            <asp:TextBox ID="mlUNIVIDNEW" runat="server"></asp:TextBox></td>
            <td><asp:Button ID="mlBTNEW" text="New Group ID" runat="server" /></td>
            </ContentTemplate>
        </ajax:UpdatePanel>
        </tr>
        </table>        
