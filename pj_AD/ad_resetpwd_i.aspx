<%@ Page Language="VB" MasterPageFile="~/pagesetting/MsPageBlank.master" AutoEventWireup="false" CodeFile="ad_resetpwd_i.aspx.vb" Inherits="backoffice_ad_resetpwd_i"  %>
...
<asp:Panel ID="pnFILL" runat="server">
    <table width="80%" cellpadding="0" cellspacing="0" border="0">
        ...
        <tr>
            <td colspan="3"><asp:Label ID="lbNEWPDW" runat="server"></asp:Label></td>
        </tr>        
